...
public class LeftScreen1 implements Screen, GestureDetector.GestureListener {
    final Main game;
    ...
    public boolean fling(float velocityX, float velocityY, int button) {
        if (velocityX < -2000) game.setScreen(new RightScreen1(game));
