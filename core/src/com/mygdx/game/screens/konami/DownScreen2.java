...
public class DownScreen2 implements Screen, GestureDetector.GestureListener {
    final Main game;
    ...
    public boolean fling(float velocityX, float velocityY, int button) {
        if (velocityX > 2000) game.setScreen(new LeftScreen1(game));
