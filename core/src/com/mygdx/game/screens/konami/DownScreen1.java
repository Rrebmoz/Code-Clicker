...
public class DownScreen1 implements Screen, GestureDetector.GestureListener {
    final Main game;
    ...
    public boolean fling(float velocityX, float velocityY, int button) {
        if (velocityY < -2000) game.setScreen(new DownScreen2(game));
